...
当前先看 [代码导航地图](docs/learning/code-navigation-map.md) 与 [代码注释与定位约定](docs/learning/code-commenting-guide.md)，再从 [Stage 17 学习说明](docs/learning/stage-17-controlled-ocr.md)完成本阶段验收；候选版演示与事实边界见 [候选版事实表](docs/candidate-version.md)。
